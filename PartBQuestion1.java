    ...
    public static void main(String[] args) {
        ...
        if ( (y == 'y') || (y == 'Y')){
            ...
            if ( id == 1){//if code item is 1
             String a1 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             quantity1 = Integer.parseInt(a1);
             total1 = (float)(quantity1 * 34.55);//calculate the total price of item 1 multiple with the quantity of item 1
             ...
             System.out.println("1\t\tSHOE\t\tRM 34.55\t   "+quantity1+"\t\t"+"RM "+total1);//display the code item 1 
            }else if ( id == 2){//if code item is 2
             String a2 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             quantity2 = Integer.parseInt(a2);
             total2 = (float)(quantity2 * 44.29);//calculate the total price of item 2 multiple with the quantity of item 2
             System.out.println("2\t\tSHIRT\t\tRM 44.29\t   "+quantity2+"\t\t"+"RM "+total2);//display the code item 2 
            }else if ( id == 3){//if code item is 3
             String a3 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             quantity3 = Integer.parseInt(a3);
             total3 = (float)(quantity3 * 64.35);//calculate the total price of item 3 multiple with the quantity of item 3
             //if the total price is more than RM 200 he/she will get the rebate for the item
             if ( total3 > 200.00){
                 discount1 = rebate.kira(discount1);//calculate the rebate
             }
             System.out.println("3\t\tPANTS\t\tRM 64.35\t   "+quantity3+"\t\t"+"RM "+total3);//display the code item 3 
            }else if ( id == 4){//if code item is 4
             String a4 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             quantity4 = Integer.parseInt(a4);
             total4 = (float)(quantity4 * 84.20);//calculate the total price of item 4 multiple with the quantity of item 4
             //if the total price is more than RM 200 he/she will get the rebate for the item
             if ( total4 > 200.00){
                 discount2 = rebate.kira(discount2);//calculate the rebate
             }
             System.out.println("4\t\tJEANS\t\tRM 84.20\t   "+quantity4+"\t\t"+"RM "+total4);//display the code item 4  
            }else if ( id == 5){//if code item is 5
             String a5 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             ...
             System.out.println("5\t\tFAN\t\tRM 51.59\t   "+quantity5+"\t\t"+"RM "+total5);//display the code item 5  
            }else if ( id == 6){//if code item is 6
             String a6 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             ...
             System.out.println("6\t\tIRON\t\tRM 24.45\t   "+quantity6+"\t\t"+"RM "+total6);//display the code item 6    
            }else if ( id == 7){//if code item is 7
             String a7 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             ...
             System.out.println("7\t\tTRAY\t\tRM 51.99\t   "+quantity7+"\t\t"+"RM "+total7);//display the code item 7      
            }else if ( id == 8){//if code item is 8
             String a8 = JOptionPane.showInputDialog(null,"How many you want to purchase?","Transaction System",JOptionPane.QUESTION_MESSAGE);
             ...
             System.out.println("8\t\tRICE\t\tRM 24.76\t   "+quantity8+"\t\t"+"RM "+total8);//display the code item 8      
            }else if ( id >= 9){//if code item more than 9
                JOptionPane.showMessageDialog(null,"You key in the wrong code !!","Error Message",JOptionPane.ERROR_MESSAGE);
                product++;
            ...
            //To display the error message if the value is not enough to pay the net of total price of item
            ...
            System.out.println("Amount Paid : RM " + String.format("%.2f",amountpay));//display the amount that user key in to pay the net of total price
            ...
            System.out.println("Change : RM " + String.format("%.2f",change));//display the change of user money
            System.out.println("------------------------------------------------------------------------------");
            ...
            System.out.println("Total Purchased : RM "+ String.format("%.2f",totalprice));//display the total price before GST and other discounts
            System.out.println("Rebates : " + totalrebate);//display the total rebate that the user get
            totalprice = bundar(totalprice, 2);//round off the total price to two decimal places
            totalgst = gst.count(totalprice);//calculate the sum of (total price + GST)
            totalgst = bundar(totalgst, 2);//round off the sum of (total price + GST) to two decimal places
            totaldiscounts = g.calc(totalgst);//calculate the discount that the user get
            totaldiscounts = bundar(totaldiscounts, 2);//round off the discount to two decimal places
            System.out.println("GST(Goverment Service Tax) : 6%");
